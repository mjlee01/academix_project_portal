        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Welcome to AcademiX, where education meets efficient project management. Our platform streamlines academic projects with intuitive tools that empower collaboration, organization, and innovation. Join us in shaping the future of education through seamless project coordination.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">© 2024 AcademiX. All rights reserved.</div>
